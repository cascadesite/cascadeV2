    ...
    <div>
      ...
      <div id="iframeContainer" class="iframe-container hidden">
        ...
        <div class="iframe-controls">
          <button class="iframe-button" @click="hideIframe">&lt;</button>
          <button class="iframe-button" @click="toggleFullscreen">⛶</button>
        </div>
      </div>
    </div>
  </template>
  ...
  export default {
    ...
    methods: {
      ...
      createGameCard(game) {
        ...
        card.addEventListener('click', () => this.showIframe(game.path));
      },
      showIframe(path) {
